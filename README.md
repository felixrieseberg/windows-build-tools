...
## Mirror
To use a mirror of the python, set a `PYTHON_MIRROR` environment variable first. To do that with PowerShell, simply run `$env:PYTHON_MIRROR = "https://npm.taobao.org/mirrors/python/"`.
